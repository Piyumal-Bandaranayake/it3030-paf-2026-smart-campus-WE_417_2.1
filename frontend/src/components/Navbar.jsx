          ...
          <div className="flex items-center gap-8">
            ...
            {user && (
              <>
                ...
                <Link to="/admin-dashboard" className="text-sm font-medium text-indigo-400 transition-colors hover:text-indigo-300">Admin</Link>
              </>
            )}
          </div>
        </div>
        ...
        <div>
          {user ? (
            <div className="flex items-center gap-4">
              ...
              {user.profilePicture ? (
                <img src={user.profilePicture} alt="Profile" className="h-10 w-10 rounded-full border border-indigo-500/50" />
              ) : (
